...
<ul class="nav flex-column navbar-light bg-dark">
  <li class="nav-item">
    <a class="nav-link active" href="#">Artikelen</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">Medewerkers</a>
  </li>
</ul>

<!-- <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReGIIBYukIpsdMJeaMPdd1YDh1feeqeIXNSA&usqp=CAU" alt="">
<img src="https://miesbloemenplus.nl/image/313swqjcpvd5z0h5/" alt=""> -->
