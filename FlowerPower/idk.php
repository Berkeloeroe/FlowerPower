...
<!-- menu items -->
  ...
  <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active"> <a class="nav-link" href="registreren.php">Registreren<span class="sr-only">(current)</span></a></li>
    </ul>
  </div>
</nav>

<!-- Medewerker of klant vraag -->
<div class="vraag">
<center>
<p>Ben je een</p>
<a class="na" href="LoginEmployee.php">medewerker</a><br>
<p>of een</p>
<a class="na" href="LoginCustomer.php">klant?</a><br>
</center>
</div>
